$(document).ready(function () {
    ...
    var adverbios = ['Fácilmente', 'Lentamente', 'Cuidadosamente', 'Simplemente', 'Felizmente', 'Naturalmente', 'Bien','Mal','Mejor','Peor','Correctamente','Incorrectamente','Tranquilamente','Repentinamente','Realmente','Exitosamente','En realidad'];
    var adverbs = ['Easily', 'Slowly', 'Carefully', 'Simply', 'Happily', 'Naturally', 'Well','Badly','Better','Worse','Right','Wrong','Quietly','Suddenly','Really','Successfully','Actually'];
