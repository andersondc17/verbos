$(document).ready(function () {
    ...
    var adverbios = ['Hoy', 'Ayer', 'Mañana', 'Ahora', 'Entonces', 'Después', 'Tarde','Temprano','Antes','Pronto','Nunca','Esta noche','Otra vez','A veces','Siempre','A menudo','Anoche'];
    var adverbs = ['Today', 'Yesterday', 'Tomorrow', 'Now', 'Then', 'After', 'Late','Early','Before','Soon','Never Ever','Tonight','Again','Sometimes','Always','Often','Last night'];
