$(document).ready(function () {
  ...
  var verbosPasadoSimple = ['Bore', 'Bent', 'Bled', 'Bred', 'Burst', 'Dealt', 'Forbade', 'Hung', 'Held', 'Laid', 'Led', 'Let', 'Rang', 'Sewed', 'Showed', 'Sank', 'Sat', 'Stood', 'Stuck', 'Tore', 'Bound', 'Burnt', 'Crept', 'Found out', 'Leapt', 'Slung', 'Sowed', 'Wound', 'Thrust', 'Strove', 'Mistook', 'Broadcast', 'Bid', 'Cast', 'Fled', 'Ground', 'knit', 'Overcame', 'Sped', 'Sprang', 'Clung', 'Shore', 'Shrank', 'Slid', 'Spilt', 'Split', 'Spoilt', 'Spread', 'Stung', 'Strode', 'Struck', 'Swelled', 'Swung', 'Underwent', 'Undertook', 'Wove', 'Wept', 'Withdrew', 'Wrung','Forsook','Befell','Betook','Dwelt','Unwound','Unfroze','Strewed','Throve'];
  var verbosPasadoParticipio = ['Borne', 'Bent', 'Bled', 'Bred', 'Burst', 'Dealt', 'Forbidden', 'Hung', 'Held', 'Laid', 'Led', 'Let', 'Rung', 'Sewn', 'Shown', 'Sunk', 'Sat', 'Stood', 'Stuck', 'Torn', 'Bound', 'Burnt', 'Crept', 'Found out', 'Leapt', 'Slung', 'Sown', 'Wound', 'Thrust', 'Striven', 'Mistaken', 'Broadcast', 'Bid', 'Cast', 'Fled', 'Ground', 'knit', 'Overcome', 'Sped', 'Sprung', 'Clung', 'Shorn', 'Shrunk', 'Slid', 'Spilt', 'Split', 'Spoilt', 'Spread', 'Stung', 'Stridden', 'Struck', 'Swollen', 'Swung', 'Undergone', 'Undertaken', 'Woven', 'Wept', 'Withdrawn', 'Wrung','Forsaken','Befallen','Betaken','Dwelt','Unwound','Unfrozen','Strewn','Thriven'];
  var verbosTraduccion = ['Soportar', 'Doblar', 'Sangrar', 'Criar', 'Estallar', 'Tratar', 'Prohibir', 'Colgar', 'Sostener', 'Poner', 'Conducir', 'Dejar', 'Llamar', 'Coser', 'Mostrar', 'Hundir', 'Sentarse', 'Estar de pie', 'Pegar', 'Rasgar', 'Atar', 'Quemar', 'Arrastrarse', 'Averiguar', 'Saltar', 'Tirar', 'Sembrar', 'Enrollar', 'Empujar', 'Esforzarse', 'Equivocarse', 'Transmitir', 'Pujar', 'Arrojar', 'Huir', 'Moler', 'Tejer', 'Vencer', 'Acelerar', 'Saltar', 'Agarrarse', 'Esquilar', 'Encogerse', 'Resbalar', 'Derramar', 'Partir', 'Estropear', 'Extender', 'Picar', 'Dar zancadas', 'Golpear', 'Hinchar', 'Columpiarse', 'Sufrir', 'Emprender', 'tejer', 'Llorar', 'Retirarse', 'Torcer','Abandonar','Suceder','Dirigirse','Residir','Desenrollar','Descongelar','Esparcir','Florecer'];
