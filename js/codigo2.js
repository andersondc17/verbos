$(document).ready(function () {
    ...
    var verbosTraduccion = ['Soportar','Doblar','Sangrar','Criar','Estallar','Tratar','Prohibir','Colgar','Sostener','Poner','Conducir','Permitir','Llamar','Coser','Mostrar','Hundir','Sentarse','Estar de pie','Pegar','Rasgar'];
