$(document).ready(function () {
  ...
  var verbosPasadoParticipio = ['Borne', 'Bent', 'Bled', 'Bred', 'Burst', 'Dealt', 'Forbidden', 'Hung', 'Held', 'Laid', 'Led', 'Let', 'Rung', 'Sewn', 'Shown', 'Sunk', 'Sat', 'Stood', 'Stuck', 'Torn', 'Bound', 'Burnt', 'Crept', 'Found out', 'Leapt', 'Slung', 'Sown', 'Wound', 'Thrust', 'Striven', 'Mistaken', 'Broadcast', 'Bid', 'Cast', 'Fled', 'Ground', 'knit', 'Overcome', 'Sped', 'Sprung', 'Clung', 'Shorn', 'Shrunk', 'Slid', 'Spilt', 'Split', 'Spoilt', 'Spread', 'Stung', 'Stridden', 'Struck', 'Swollen', 'Swung', 'Undergone', 'Undertaken', 'Woven', 'Wept', 'Withdrawn', 'Wrung','Forsaken','Befallen','Betaken','Dwelt','Unwound','Unfrozen','Strewn','Thriven','Abode','Backslid','Begotten','Begirt','Beheld','chidden','Fit','Inset'];
