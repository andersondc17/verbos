$(document).ready(function () {
    ...
    var palabra = ['primavera', 'niños', 'flores', 'naturaleza', 'verano', 'caluroso','playa','arena','mar','otoño','tibio','hoja','árbol','nube','invierno','frío','muy frío','estación'];
    var word = ['spring', 'children', 'flowers', 'nature', 'summer', 'hot','beach','sand','sea','fall','warm','leaf','tree','cloud','winter','cool','cold','season'];
