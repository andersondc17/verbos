$(document).ready(function () {
    ...
    var adverbios = ['Demasiado', 'Bastante', 'Muy', 'Mucho', 'Más', 'Menos', 'Poco','Nada','Escaso','Algo','Apenas','Todo'];
    var adverbs = ['Too much', 'Quite', 'Very', 'Much', 'More', 'Less', 'Little bit','Nothing','Little','Something','Barely','Everything'];
